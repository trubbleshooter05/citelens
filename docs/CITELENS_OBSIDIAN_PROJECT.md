...
Visitor enters a brand or website, previews a demo AI visibility workflow using sample data, and joins early access for live AI prompt checks.
...
- The MVP uses sample report data only.
- Public copy must not imply that the demo form performs a live audit.
- Sitemap should be submitted in Google Search Console as `https://citelens.app/sitemap.xml`.
